...
export function Quiz() {
    ...
    return (
        <div className="container">
                    ...
                    <div className="modal-dialog modal-dialog-centered">
                        <div className="modal-content text-center">
                            ...
                            <div className="modal-footer">
                                <button type="button" className="btn btn-secondary" onClick={() => navigate('/Stats')}>Ver Estadísticas Generales</button>
                                <button type="button" className="btn btn-primary" onClick={() => navigate('/Decks')}>Volver</button>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <button className="btn btn-primary mt-3 mx-3" onClick={() => handleAttempt(false)}>
                No lo sé
            </button>
            <button className="btn btn-primary mt-3 mx-3" onClick={handleAnswer}>
                Mostrar Respuesta
            </button>
            <button className="btn btn-primary mt-3 mx-3" onClick={() => handleAttempt(true)}>
                Lo sé
            </button>
        </div>
    );
